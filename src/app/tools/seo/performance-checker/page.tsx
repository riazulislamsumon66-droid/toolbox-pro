...
export default function PerformanceCheckerPage() {
  ...
  const handleAnalyze = () => setResults(checkPerformance(html))
  return (
    <ToolPage title="Performance Checker" description="Check page size, image dimensions, scripts, and inline styles for speed." icon="\u26a1" category="seo">
