...
export default function ImageAltCheckerPage() {
  ...
  const handleAnalyze = () => setResults(checkImageAltText(html))
  return (
    <ToolPage title="Image Alt Text Checker" description="Find missing alt text on images — important for SEO and accessibility." icon="🖼️" category="seo">
