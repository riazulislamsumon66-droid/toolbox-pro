...
export default function MobileCheckerPage() {
  ...
  const handleAnalyze = () => setResults(checkMobileFriendly(html))
  return (
    <ToolPage title="Mobile-Friendly Checker" description="Check viewport, font sizes, fixed widths, and touch targets for mobile SEO." icon="\ud83d\udcf1" category="seo">
