...
export default function StructuredDataCheckerPage() {
  ...
  const handleAnalyze = () => setResults(checkStructuredData(html))
  return (
    <ToolPage title="Structured Data Checker" description="Check JSON-LD and microdata schema markup for rich snippets." icon="{ }" category="seo">
