...
export default function LinkAnalyzerPage() {
  ...
  const handleAnalyze = () => setResults(checkLinks(html))
  return (
    <ToolPage title="Link Analyzer" description="Analyze internal, external, nofollow links and anchor text for SEO." icon="\ud83d\udd17" category="seo">
